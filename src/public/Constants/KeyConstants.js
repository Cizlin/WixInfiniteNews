...
export const KEY_VALUE_CUSTOMIZATION_ARMOR_LSHOULDER_RSHOULDER_KEY = "ArmorLShoulderRShoulderOffset";
export const KEY_VALUE_CUSTOMIZATION_ARMOR_CHEST_GLOVES_KEY = "ArmorChestGlovesOffset";
export const KEY_VALUE_CUSTOMIZATION_ARMOR_KNEE_HIP_WRISTS_KEY = "ArmorKneeHipWristsOffset";
